...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  "SELECT projects.title, (sum(pledges.amount)- projects.funding_goal) as overfunding FROM projects INNER JOIN pledges ON projects.id = pledges.project_id GROUP by projects.id HAVING sum(pledges.amount) >= projects.funding_goal;"
end
